...
export default async function CreditSuccessPage({ searchParams }: PageProps) {
  ...
  return (
    <div className="p-6 flex flex-col items-center justify-center min-h-[60vh]">
      <div className="max-w-md w-full text-center">
        ...
        <h1 className="text-2xl font-bold text-gray-900 mb-2">Paiement reçu !</h1>
        <p className="text-gray-500 text-sm mb-1">Votre recharge est en cours de traitement.</p>
